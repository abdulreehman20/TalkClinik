...
import { IconArrowDown, IconMenu2, IconX } from "@tabler/icons-react";
import {
  motion,
  AnimatePresence,
  useScroll,
        ...
        >
          ...
          <motion.span
            ...
            animate={{
              ...
              x: hovered === idx ? 0 : -4,
              width: hovered === idx ? "auto" : 0,
            }}
            transition={{ duration: 0.15 }}
            className="relative z-20 overflow-hidden text-tertiary"
          >
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <span className="flex size-7 items-center justify-center rounded-full bg-tertiary text-xs font-bold text-white">
        TC
      </span>
      <span className="font-heading text-base font-semibold tracking-tight text-black dark:text-white">
        TalkClinik
      </span>
    </a>
  );
